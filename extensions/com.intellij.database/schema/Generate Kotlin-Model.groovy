...
def generate(out, tableName, className, fields) {
    ...
    out.println "import com.vladsch.kotlin.jdbc.SqlQuery"
    ...
    out.println "    }"
    out.println ""
    out.println "    fun listQuery(vararg params: Pair<String, Any?>): SqlQuery {"
    out.println "        return Model.listQuery(tableName, params)"
    out.println "    }"
    out.println ""
    out.println "    fun listQuery(params: Map<String, Any?>): SqlQuery {"
    out.println "        return Model.listQuery(tableName, params)"
    out.println "    }"
    out.println "  }"
    out.println "}"
